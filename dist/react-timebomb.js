...
class ReactTimebomb extends React.Component {
    ...
    render() {
        ...
        const maxDate = this.props.maxDate
            ...
            : undefined;
        return (React.createElement(react_slct_1.Select, { value: value, placeholder: placeholder, className: className }, ({ placeholder, open, onToggle, onRef, MenuContainer }) => (React.createElement(Container, { ref: onRef, className: "react-timebomb" },
