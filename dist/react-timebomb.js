...
class Menu extends React.PureComponent {
    ...
    renderTime() {
        return (React.createElement(time_1.MenuTime, { date: this.props.date, timeStep: this.props.timeStep, onChange: this.props.onSelectTime }));
    }
    renderConfirm() {
