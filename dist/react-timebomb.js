...
class ReactTimebomb extends React.Component {
    ...
    render() {
        ...
        const value = valueText
            ...
            : this.props.value;
        return (React.createElement(react_slct_1.Select, { value: value, placeholder: placeholder }, ({ placeholder, open, onToggle, onRef, MenuContainer }) => {
    ...
    onClose() {
        ...
        setTimeout(() => {
            ...
            const isValid = validDate
                ...
                : validDate;
            if (!isValid && value) {
                const formattedDate = utils_1.dateFormat(value, format);
                if (this.state.valueText !== formattedDate) {
                    this.onChangeValueText(formattedDate);
                    return;
                }
            }
            if (!utils_1.dateEqual(value, validDate)) {
                if (value) {
                    const formattedDate = utils_1.dateFormat(value, format);
                    this.onChangeValueText(formattedDate);
                }
...
class Menu extends React.PureComponent {
    ...
    renderConfirm() {
        ...
        return (React.createElement(Confirm, null,
            React.createElement(button_1.Button, { tabIndex: -1, disabled: validDate === null, onClick: () => this.props.onSubmit() }, "Ok")));
    }
    onSelectDay(e) {
...
//# sourceMappingURL=react-timebomb.js.map?tm=1546212245291
});
...
//# sourceMappingURL=react-timebomb.js.map?tm=1546258509775