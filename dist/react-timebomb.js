...
class Menu extends React.PureComponent {
    ...
    renderTime() {
        return (React.createElement(time_1.MenuTime, { date: this.props.date, timeStep: this.props.timeStep, topDivider: this.props.showDate, onChange: this.props.onSelectTime }));
    }
    renderConfirm() {
    ...
    onChangeMonth(direction) {
        ...
        switch (direction) {
            case 'next':
                onSelectMonth(utils_1.addMonths(date, 1));
                break;
            case 'prev':
                onSelectMonth(utils_1.subtractMonths(date, 1));
                break;
        }
    }
}
...
//# sourceMappingURL=react-timebomb.js.map?tm=1549312395838
});
...
class MenuTime extends React.PureComponent {
    render() {
        ...
        return (React.createElement(Container, { topDivider: topDivider, className: "react-timebomb-time" },
            React.createElement(number_input_1.NumberInput, { date: date, step: 1, mode: "hour", onChange: onChange }),
            React.createElement(Divider, { className: "divider" }, ":"),
            React.createElement(number_input_1.NumberInput, { date: date, step: timeStep, mode: "minute", onChange: onChange })));
    }
}
exports.MenuTime = MenuTime;
//# sourceMappingURL=time.js.map
});
___scope___.file("number-input.jsx", function(exports, require, module, __filename, __dirname){
...
//# sourceMappingURL=react-timebomb.js.map?tm=1549069059579
});
...
//# sourceMappingURL=react-timebomb.js.map?tm=1549312882276