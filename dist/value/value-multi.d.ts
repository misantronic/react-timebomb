...
export declare const ValueMulti: React.ForwardRefExoticComponent<Pick<import("../typings").ReactTimebombValueProps, "disabled" | "className" | "placeholder" | "onSubmit" | "open" | "format" | "mode" | "mobile" | "innerRef" | "minDate" | "maxDate" | "showDate" | "showTime" | "allowValidation" | "arrowButtonComponent" | "clearComponent" | "arrowButtonId" | "iconComponent" | "labelComponent" | "timeStep" | "hoverDate" | "onToggle" | "onChangeValueText" | "onChangeFormatGroup" | "onAllSelect" | "onClear"> & {
