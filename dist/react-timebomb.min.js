...
`;class h extends o.PureComponent{constructor(e){super(e),this.state={},this.onChange=this.onChange.bind(this),this.onFocusIn=this.onFocusIn.bind(this),this.onFocusOut=this.onFocusOut.bind(this),this.onStepUp=this.onStepUp.bind(this),this.onStepDown=this.onStepDown.bind(this)}get renderedValue(){return this.state.focused?this.state.value:isFinite(this.state.value)?a.formatNumberRaw(this.state.value):""}componentDidMount(){const{date:e}=this.props;e&&this.setState({value:this.getDateValue(e)})}componentDidUpdate(e,t){const{date:n,mode:o,onChange:s}=this.props,{value:a,focused:i}=this.state;if(n&&e.date.getTime()!==n.getTime()&&this.setState({value:this.getDateValue(n)}),t.value!==a&&""!==a&&i){s(this.manipulateDate(a),o)}}render(){const{step:e,mode:t}=this.props;return o.createElement(l,{className:`react-timebomb-number-input ${t}`,onMouseEnter:this.onFocusIn,onMouseLeave:this.onFocusOut},o.createElement(c,{"data-react-timebomb-selectable":!0,type:"number",step:e,value:this.renderedValue,onChange:this.onChange,onFocus:this.onFocusIn}),o.createElement(i,null,o.createElement(r,{"data-react-timebomb-selectable":!0,tabIndex:-1,onClick:this.onStepUp},"▲"),o.createElement(r,{"data-react-timebomb-selectable":!0,tabIndex:-1,onClick:this.onStepDown},"▼")))}manipulateDate(e){const t=new Date(this.props.date),n=parseInt(e||"0",10);switch(this.props.mode){case"hour":t.setHours(n);break;case"minute":t.setMinutes(n)}return t}getDateValue(e){switch(this.props.mode){case"hour":return e.getHours();case"minute":return e.getMinutes()}return 0}onFocusIn(){this.setState({focused:!0})}onFocusOut(){this.setState({focused:!1})}onChange(e){const{date:t}=this.props,{value:n}=e.currentTarget;if(""===n)this.setState({value:n});else if(t){const e=this.manipulateDate(n);this.setState({value:this.getDateValue(e)})}}onStepUp(){const{date:e,step:t}=this.props,{value:n}=this.state;if(e&&void 0!==n){const e=this.manipulateDate(n+t);this.setState({value:this.getDateValue(e)})}}onStepDown(){const{date:e,step:t}=this.props,{value:n}=this.state;if(e&&void 0!==n){const e=this.manipulateDate(n-t);this.setState({value:this.getDateValue(e)})}}}h.defaultProps={step:1},n.NumberInput=h},e.f[9]=function(t,n){Object.defineProperty(n,"__esModule",{value:!0});const o=e.r("react"),s=e.r("styled-components"),a=e.r(3),i=e.r(2),r=s.default.div`
